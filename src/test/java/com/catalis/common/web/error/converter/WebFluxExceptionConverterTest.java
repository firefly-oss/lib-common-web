...
class WebFluxExceptionConverterTest {
    ...
    void convert_MethodNotAllowedException_ReturnsMethodNotAllowedException() {
        ...
        // Assert
        assertTrue(result instanceof com.catalis.common.web.error.exceptions.MethodNotAllowedException);
        assertEquals(HttpStatus.METHOD_NOT_ALLOWED, result.getStatus());
        assertEquals("METHOD_NOT_ALLOWED", result.getCode());

        com.catalis.common.web.error.exceptions.MethodNotAllowedException typedResult =
                (com.catalis.common.web.error.exceptions.MethodNotAllowedException) result;
    ...
    void convert_UnsupportedMediaTypeStatusException_ReturnsUnsupportedMediaTypeException() {
        ...
        // Assert
        assertTrue(result instanceof com.catalis.common.web.error.exceptions.UnsupportedMediaTypeException);
        assertEquals(HttpStatus.UNSUPPORTED_MEDIA_TYPE, result.getStatus());
        assertEquals("UNSUPPORTED_MEDIA_TYPE", result.getCode());

        com.catalis.common.web.error.exceptions.UnsupportedMediaTypeException typedResult =
                (com.catalis.common.web.error.exceptions.UnsupportedMediaTypeException) result;
    ...
    void convert_DataBufferLimitException_ReturnsPayloadTooLargeException() {
        ...
        // Assert
        assertTrue(result instanceof com.catalis.common.web.error.exceptions.PayloadTooLargeException);
        assertEquals(HttpStatus.PAYLOAD_TOO_LARGE, result.getStatus());
        assertEquals("PAYLOAD_TOO_LARGE", result.getCode());

        com.catalis.common.web.error.exceptions.PayloadTooLargeException typedResult =
                (com.catalis.common.web.error.exceptions.PayloadTooLargeException) result;
    ...
    void convert_ServerWebInputExceptionWithPreconditionFailed_ReturnsPreconditionFailedException() {
        ...
        // Assert
        assertTrue(result instanceof com.catalis.common.web.error.exceptions.PreconditionFailedException);
        assertEquals(HttpStatus.PRECONDITION_FAILED, result.getStatus());
        assertEquals("PRECONDITION_FAILED", result.getCode());

        com.catalis.common.web.error.exceptions.PreconditionFailedException typedResult =
                (com.catalis.common.web.error.exceptions.PreconditionFailedException) result;
