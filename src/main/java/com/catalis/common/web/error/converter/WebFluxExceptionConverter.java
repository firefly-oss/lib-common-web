...
public class WebFluxExceptionConverter implements ExceptionConverter<Exception> {
    ...
    public BusinessException convert(Exception exception) {
        if (exception instanceof MethodNotAllowedException) {
            ...
            return com.catalis.common.web.error.exceptions.MethodNotAllowedException.forResource(
                    method,
            ...
            return com.catalis.common.web.error.exceptions.UnsupportedMediaTypeException.forMediaType(
            ...
            return com.catalis.common.web.error.exceptions.PayloadTooLargeException.forSize(maxSize, actualSize);
            ...
            return com.catalis.common.web.error.exceptions.PreconditionFailedException.forPrecondition(
                    "unknown",
